...
plt.tight_layout()
plt.savefig(os.path.join(METRICS_DIR, 'training_e4_scratch_metrics.png'))
plt.close()

print(f"メトリクスのグラフを {os.path.join(METRICS_DIR, 'training_e4_scratch_metrics.png')} に保存しました。")