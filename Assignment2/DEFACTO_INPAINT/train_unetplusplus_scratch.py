...
MODEL_FILE = os.path.join(MODEL_DIR, 'UnetPlusPlus_scratch_model.pth')
METRICS_DIR = './metrics/'
...
plt.tight_layout()
plt.savefig(os.path.join(METRICS_DIR, 'training_scratch_metrics.png'))
plt.close()

print(f"メトリクスのグラフを {os.path.join(METRICS_DIR, 'training_scratch_metrics.png')} に保存しました。")
